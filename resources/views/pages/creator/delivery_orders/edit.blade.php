                    ...
                    <form action="{{ route('delivery-orders.update', $delivery_order) }}" method="POST">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                is-invalid
                            @enderror"
                                    name="do_purpose" value="{{ $delivery_order->do_purpose }}">
                                @error('do_purpose')
                            ...
                            <div class="form-group">
                                ...
                                is-invalid
                            @enderror"
                                    name="do_origin" value="{{ $delivery_order->do_origin }}">
                                @error('do_origin')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                is-invalid
                            @enderror"
                                    name="origin_postal_code" value="{{ $delivery_order->origin_postal_code }}">
                            ...
                            <div class="form-group">
                                ...
                                is-invalid
                            @enderror"
                                    name="do_destination" value="{{ $delivery_order->do_destination }}">
                            ...
                            <div class="form-group">
                                ...
                                is-invalid
                            @enderror"
                                    name="destination_postal_code" value="{{ $delivery_order->destination_postal_code }}">
                            ...
                            <div class="form-group">
                                ...
                                is-invalid
                            @enderror"
                                    name="item_name" value="{{ $delivery_order->item_name }}">
                                @error('item_name')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                is-invalid
                            @enderror"
                                    name="item_description" value="{{ $delivery_order->item_description }}">
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        is-invalid
                                    @enderror"
                                            name="item_length" value="{{ $delivery_order->item_length }}">
                                        @error('item_length')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        is-invalid
                                    @enderror"
                                            name="item_width" value="{{ $delivery_order->item_width }}">
                                        @error('item_width')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        is-invalid
                                    @enderror"
                                            name="item_height" value="{{ $delivery_order->item_height }}">
                                        @error('item_height')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        is-invalid
                                    @enderror"
                                            name="item_weight" value="{{ $delivery_order->item_weight }}">
                                        @error('item_weight')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        is-invalid
                                    @enderror"
                                            name="item_qty" value="{{ $delivery_order->item_qty }}">
                                        @error('item_qty')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        is-invalid
                                    @enderror"
                                            name="item_price" value="{{ $delivery_order->item_price }}">
                                        @error('item_price')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
